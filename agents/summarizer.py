...
def summarizer_node(state: Dict[str, Any]) -> Dict[str, Any]:
    ...
    system_prompt = (
        ...
        "- ALWAYS produce a summary if there is ANY relevant information in the context.\n"
        "- Even partial or tangential information should be summarized -- do your best.\n"
        "- Return 'INSUFFICIENT_CONTEXT' ONLY if the context is completely empty or contains nothing but errors.\n\n"
        "You MUST organize output into these sections (as bullet points):\n"
        "- Key Findings\n"
        "- Methods / Approaches (if present)\n"
